...
## 🛰️ Executive Identity & Core Stack

```yaml
Candidate      : Vishnu Sai Neelam
Official Title : Packaged App Development Associate @ Accenture (Apr 2024 – May 2026)
Specialization : ServiceNow / ITSM | Technical Application Support | L2/L3 Operations
Certifications : Microsoft Certified: Azure Database Administrator (DP-300)
                 Microsoft Certified: Azure Fundamentals (AZ-900)
Core Focus     : Incident/Problem/Change Management, CMDB, REST APIs, SQL Diagnostics
Flagship Tech  : ResolveX (Enterprise Service Management) & VILXON Engine
